...
| v0.2.1 | UX refactor — Shadcn sidebar, dark mode, brand colors, compact tables, quick start | In progress |
| v0.2.2 | E2E test foundation (Cypress), activity polish, nuqs URL state | — |
